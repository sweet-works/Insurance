            ...
            <el-table
                ...
                width="180">
                    <template slot-scope="scope">
                        <el-input v-model="scope.row[item]" type="text"/>
                    </template>
                </el-table-column>
                <el-table-column
                    label="自核结论"
                    ...
                    prop="self">
                    <template slot-scope="scope">
                        <el-input v-model="scope.row.self" type="text"/>
                    </template>
                </el-table-column>
                <el-table-column
                    label="转人工核保级别"
                    ...
                    prop="per">
                    <template slot-scope="scope">
                        <el-input v-model="scope.row.per" type="text"/>
                    </template>
                </el-table-column>
            </el-table>
        </div>
...
            }
                            ...
                            Object.values(SelectData).map((item_01) => {
                                item_01.map((item_02) => {
                                    if (item_02.value === a[j-3].factorValue) {
                                        ...
                                        this.col_name.push(this.col_middle)  // this.col_name 渲染列名
                                        // console.log(this.col_name_chinese);
                                        // console.log(this.col_name_english);
                                        // col_name end
    ...
                    }
                }
                // 遍历this.col_name_english 做为键名加到对象this.col_name_concat上
                // 英文遍历
                this.col_name_english.map((it_01) => {
                    this.it01 = it_01
                    // 中文遍历
                    this.col_name_chinese.map((it_02) => {
                        this.it02 = it_02
                    })
                })
                // 中英文拼接
                this.col_name_concat.push({
                    [this.it01]: this.it02
                })
                // console.log(this.col_name_concat);
                this.arryB = []
                this.col_name_concat.map((item_001) => {
                    // console.log(item_001)
                    this.arryB.push(item_001)
                    console.log(this.arryB);
                    // this.arryB.map((item_002) => {
                    //     console.log(item_002);
                    // })
                    // console.log(Object.keys(b));
                    // 判断Object.keys(item_01) 
                    // console.log(arr)
                })
                // console.log(this.col_name_concat);
        }
