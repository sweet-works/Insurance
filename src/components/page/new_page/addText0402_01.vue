...
            }
                            ...
                            Object.values(SelectData).map((item_01) => {
                                item_01.map((item_02) => {
                                    if (item_02.value === a[j-3].factorValue) {
                                        ...
                                        // this.col_middle.push(
                                        //     {
                                        //     "key": item_02.value,
                                        //     "value": item_02.label
                                        //     })
                                        // console.log(this.col_middle);
                                        // console.log(this.col_middle[0].key);
                                    } else if (item_02.value === a[j-2].factorValue) {
                                        this.col_middle += item_02.label // 中文
                                        this.col_middle02 += '.' + item_02.value  // 英文
                                        // this.col_middle.push(
                                        //     {
                                        //     "key": item_02.value += item_02.value,
                                        //     "value": item_02.label
                                        //     })
                                        // console.log(this.col_name);
                                        // this.col_middle.map((item_03) => {
                                        //     console.log(Object.values(item_03));
                                        // })
    ...
                }
                for (let a =0; a < this.col_name_english.length; a++) {
                    ...
                    // 遍历this.col_name_english
                    // this.col_name_english
                    // let col_name_english1 = this.col_name_english.filter(()=> { return this.col_name_english.splice(a,1) }); // 除每项的剩余数组
                    // for (let c=0;c<col_name_english1.length;c++) {
                    //     if(col_name_english1[c]===this.col_name_english[a]) {
                    //         col_name_english1[c] += c+1;
                    //     }
                    // }
